...
fddb_path = '/home/rapela/Downloads/redes/CNN_Face_Detection/FDDB/'
...
def parse_data_info(only_positive = False,limit_num = None,pos_neg_ratio = 0.5):
    ...
    neg_num = 10000
    import os
    pos_folders = '/home/rapela/Downloads/redes/CNN_Face_Detection/FDDB/positive_sample'
    neg_folders = '/home/rapela/Downloads/redes/CNN_Face_Detection/FDDB/negative_sample'
...
def main():
    ...
    out_path = fddb_path + 'negative_sample/'
    ...
    gen_neg_sample(images , out_path)
